...
class _FilterBottomSheetState extends State<FilterBottomSheet> {
                ...
                onPressed: () {
                  if (filters.selectedLocations.isEmpty) {
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(content: Text('Please select at least one location'), backgroundColor: Color(0xFF20B2AA)),
                    );
                    return;
                  }
  ...
  // <-- Make sure this method is inside the _FilterBottomSheetState class
